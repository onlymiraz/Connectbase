...
EXEC('TRUNCATE TABLE CapitalManagementProduction.forecast.SummaryColumn') AT [CAPINFWWAPV01]
...
SET @Main_Insert_Query = N'
	...
	INSERT INTO [CAPINFWWAPV01].CapitalManagementProduction.forecast.SummaryColumn ('+ @PK_Table_Columns +') 
			SELECT ' + @PK_Table_Columns + ' FROM CAPINFWWWPV01.CapitalManagementStaging.forecast.SummaryColumn
'
...
IF(@ID_Condition > 0 OR @PK_Condition > 0)
	BEGIN
		EXECUTE [CAPINFWWAPV01].CapitalManagementProduction.dbo.createtemptable 'forecast.SummaryColumn'
...
--select * from [CAPINFWWAPV01].CapitalManagementProduction.forecast.SummaryColumn
--TRUNCATE TABLE [CAPINFWWAPV01].CapitalManagementProduction.forecast.SummaryColumn