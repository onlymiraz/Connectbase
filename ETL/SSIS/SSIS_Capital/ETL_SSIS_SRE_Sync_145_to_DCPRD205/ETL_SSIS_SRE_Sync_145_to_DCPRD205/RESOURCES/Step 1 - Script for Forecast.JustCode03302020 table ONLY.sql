...
EXEC('TRUNCATE TABLE CapitalManagementDevelopment.[dbo].[Forecast.JustificationCode03302020]') AT [DBFarm205]
...
SET @Main_Insert_Query = N'
	...
	INSERT INTO [DBFarm205].CapitalManagementDevelopment.[dbo].[Forecast.JustificationCode03302020]('+ @PK_Table_Columns +') 
			SELECT ' + @PK_Table_Columns + ' FROM CAPINFWWWPV01.CapitalManagementStaging.[dbo].[Forecast.JustificationCode03302020]
'
