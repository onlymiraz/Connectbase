...
CREATE PROCEDURE TOWERS_UNIVERSE.usp_TBL_LZ_BSA_UPLOAD
/*
...
VALUES
('TOWERS_UNIVERSE.TBL_LZ_BSA_UPLOAD'
...
FROM [LOG].tbl_StoreProc
	...
	truncate table TOWERS_UNIVERSE.TBL_LZ_BSA_UPLOAD --Cannot truncate system versioned table

	bulk insert TOWERS_UNIVERSE.TBL_LZ_BSA_UPLOAD from 'd:\LZ\TOWERS_UNIVERSE\BSA_UPLOAD.TXT'
