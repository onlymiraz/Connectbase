...
CREATE PROCEDURE dbo.usp_parser_TBL_LZ_DSAT_MATRIX_UPLOAD
/*
...
VALUES
('dbo.TBL_LZ_DSAT_MAXTRIX_UPLOAD'
...
truncate table dbo.TBL_LZ_DSAT_MAXTRIX_UPLOAD --Cannot truncate system versioned table

insert INTO Playground.dbo.DSAT_MATRIX 
SELECT * 
