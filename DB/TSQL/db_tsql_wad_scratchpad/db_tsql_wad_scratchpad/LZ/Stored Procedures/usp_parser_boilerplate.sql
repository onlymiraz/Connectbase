...
CREATE PROCEDURE LZ.usp_parser_boilerplate
...
/*
	...
	truncate table LZ.tbl_BoilerPlate

	bulk insert LZ.tbl_BoilerPlate from 'd:\DataDump\somecsv.csv'
    with (fieldterminator='|', rowterminator='\n', codepage=65001, FIRSTROW=2)

	update [Safety].[LZ_MZEESAFETY]
