...
CREATE PROCEDURE [ProjApproval].[InputScreen_PreSale_CRC_Trim]
AS
	SET XACT_ABORT, NOCOUNT ON
BEGIN TRY
	BEGIN TRANSACTION
DROP TABLE IF EXISTS LOG.Tracker_Temp_ProjApproval__InputScreen_PreSale_CRC_Trim
INSERT INTO [LOG].[Tracker]
    ...
    ,[EVENTDESCRIPTION])
VALUES
('[ProjApproval].[InputScreen_PreSale_CRC_Trim]'
    ,CAST(GETDATE() AS DATETIME)
    ,'STORE PROC'
    ,'')

SELECT MAX(EVENTID) AS LATESTID  INTO LOG.Tracker_Temp_ProjApproval__InputScreen_PreSale_CRC_Trim
FROM [LOG].[Tracker]

insert into ProjApproval.InputScreen_PreSale_CRC_Trimmed
([Opportunity ID]
      ,[Start time]
      ,[SubmitttedDtm]
      ,[SubmittedBy]
  ...
  'CRC_'+[ID]
      ...
      ,[Notes]
      ,[Additional Documents]
  FROM [ProjApproval].[InputScreen_PreSale_CRC]
--    where [Project Number 1] != ''
--and  [Project Number 1] != ' '
--and  [Project Number 1] is not null
--and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 1] NOT IN
--(select [Project Number]
--from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
--)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 2] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 3] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 4] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 5] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 6] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 7] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 8] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 9] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
and [ProjApproval].[InputScreen_PreSale_CRC].[Project Number 10] NOT IN
(select [Project Number]
from [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
)
...
SELECT [Opportunity ID]
      ...
      ,[Additional Documents]
  FROM [ProjApproval].[InputScreen_PreSale_CRC_Trimmed]
where ProjApproval.[InputScreen_PreSale_CRC_Trimmed].[Opportunity ID]
NOT IN (
...
FROM LOG.Tracker T
INNER JOIN LOG.Tracker_Temp_ProjApproval__InputScreen_PreSale_CRC_Trim P
