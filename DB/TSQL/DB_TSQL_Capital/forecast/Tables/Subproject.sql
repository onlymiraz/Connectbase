...
begin
	...
	SELECT ProjectNumber, SubprojectNumber, 0.0, 0.0 FROM inserted i
	where not exists (select ProjectNumber, SubprojectNumber from forecast.SubprojectCIAC C 
						where i.ProjectNumber=C.ProjectNumber
						and i.SubprojectNumber=C.SubprojectNumber)
