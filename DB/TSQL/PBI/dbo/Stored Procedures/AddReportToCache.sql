...
UPDATE	[PowerBIReportServerTempDB].dbo.ExecutionCache WITH (ROWLOCK) -- had deadlocks caused by page lock escalation using rowlock to avoid it.
...
INSERT INTO [PowerBIReportServerTempDB].dbo.ExecutionCache
