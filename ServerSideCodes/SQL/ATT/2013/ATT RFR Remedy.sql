...
where a.fld_troublereportstate = 'closed'
 ...
 and (to_char(dte_closeddatetime-5/24,'yyyymm') in ('201601','201602')    --NEED TO CHANGE THIS EACH MONTH
    or (dte_closeddatetime is null and to_char(fld_event_end_time,'yyyymm') in ('201601','201602')))   --NEED TO CHANGE THIS EACH MONTH
...
select region, state, company, ckt_id, disp, found, create_date, cleared_dt, closed_dt, 
