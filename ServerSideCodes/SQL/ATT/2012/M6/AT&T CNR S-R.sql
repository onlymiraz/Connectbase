...
where sr.document_number = asr.document_number
  ...
  and jeopardy_reason_code in ('02','05','005','14','17','17H','18','18H','00A','00B','00C','1C','1E','1R')
  and t.task_type = 'DD'
...
group by sr.document_number, asr.request_type, jeopardy_reason_code, jeopardy_type_cd
)
order by 1

select * 
from casdw.access_service_request
where document_number = '1406233'