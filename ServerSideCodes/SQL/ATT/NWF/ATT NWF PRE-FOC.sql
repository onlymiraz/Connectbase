...
FROM (
--
SELECT DOCUMENT_NUMBER, ACNA, ACT, CLEAN, DD, NC, PON, CKT, SUPP, EVC_IND,
...
FROM (
--
SELECT A.DOCUMENT_NUMBER, REQ, ACNA, ACT, TRUNC(CLEAN) CLEAN, TRUNC(DD) DD, NC, PON, CKT, SUPP, EVC_IND, 
...
GROUP BY SR.DOCUMENT_NUMBER, ASR.REQUEST_TYPE, T2.ACTUAL_COMPLETION_DATE
ORDER BY 3
) A,
  TASK T3,
  TASK T4,
...
GROUP BY A.DOCUMENT_NUMBER, REQ, ACNA, ACT, CLEAN, DD, NC, PON, CKT, SUPP, EVC_IND, 
       T3.TASK_TYPE,
       T4.TASK_TYPE, 
       TJW.JEOPARDY_REASON_CODE,
       JT.JEOPARDY_REASON_DESCRIPTION 
