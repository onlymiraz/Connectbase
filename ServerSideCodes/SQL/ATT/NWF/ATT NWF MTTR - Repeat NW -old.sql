...
select distinct ticket_id, 
       ...
       case when acna is not null and acna <> 'BNK' then acna
	        when acna1 is not null and acna <> 'BNK' then acna1
	        when ccna1 is not null and acna <> 'BNK' then ccna1
			when acna2 is not null and acna <> 'BNK' then acna2
            when acna3 is not null and acna <> 'BNK' then acna3
