...
select age_date report_month, tas_serial, a.state, a.acna,  
       ...
       case when a.service_code = 'HC' then 'DS1'
		...
		ckt_id, report_date, cleared_date, DSPSN, DSPSN_SUBCD, 
	 TOTAL_DUR_INT_TIME ttr, TOTAL_DUR_OF_TICKET total_duration
...
where TO_CHAR(AGE_DATE, 'YYYYMMDD') in ('20110701')   --CHANGE DATE   
...
or to_char(a.age_date, 'YYYYMMDD') = '20110701'
