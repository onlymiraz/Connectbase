...
where TO_CHAR(AGE_DATE, 'YYYYMMDD') in ('20111101','20111201') --Last data month and current data month 
and TO_CHAR(REPORT_DATE, 'YYYYMMDD') >= '20111101'    ---1st day of Last data month     
...
or TO_CHAR(AGE_DATE, 'YYYYMMDD') in ('20111101','20111201') --Last data month and current data month 
  and TO_CHAR(REPORT_DATE, 'YYYYMMDD') >= '20111101'    ---1st day of Last data month    
  and d.state in ('AZ','CA','ID','IL','NV','OH','OR','WA','WI') --'IN','MI','NC','SC' 
