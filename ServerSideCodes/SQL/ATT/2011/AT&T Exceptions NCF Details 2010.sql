...
and TO_CHAR(prv.LOAD_DATE, 'YYYYMM') = '201111'  --CHANGE DATES (MONTH IN ARREARS)
...
and TO_CHAR(rep.REPORT_DATE,'YYYYMMDD') between '20111101' and '20111231'  --CHANGE DATES  Current Month (in arrears) through Next Month   
...
select 'E.2.3', 'NCF', '01-Dec-2011', '31-Dec-2011',
