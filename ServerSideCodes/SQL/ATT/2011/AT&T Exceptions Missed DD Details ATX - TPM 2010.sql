...
select 'E.2.1', 'DD_NOT_MET', '01-Dec-2011', '31-Dec-2011', 
  case when substr(prchs_order_no,3,1) = 'H' then 'Inter-office Facilities'
	   ...
	   'FTR13', prchs_order_no, ecckt, ckr, order_no, due_sched_date, dsrd_date, due_cmpln_date, why_miss, NULL, NULL,
