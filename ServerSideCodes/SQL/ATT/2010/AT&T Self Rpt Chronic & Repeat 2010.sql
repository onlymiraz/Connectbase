...
and TO_CHAR(AGE_DATE, 'YYYYMMDD') in ('20101101','20101201') --Last data month and current data month 
and TO_CHAR(REPORT_DATE, 'YYYYMMDD') >= '20101101'    ---1st day of Last data month    
