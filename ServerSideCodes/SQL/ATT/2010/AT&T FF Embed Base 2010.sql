...
where to_char(age_date,'YYYYMMDD') in '20101201'
...
FROM ossams_mart.tb_dw_ossams_embed_base e,
  ...
  and acna in ('AAX','ACF','ACH','ADM','AEC','AGS','AGZ','AHA','AHD','AHM','AHO',
			 ...
			 'SBG','SBM','SBN','SCU','SHI','SLL','SMC','SNP','STH','SUF','SWM',
			 'SWP','SWT','SWV','SYC','SZM','TGH','TQU','UMT','VGD','VRA',
			 'WBT','WGL','WLG','WLZ','WVO','WWC','TPM','ACC','ANF','ETL','IPS','ATX')
  and c.state in ('AZ','CA','ID','IL','IN','MI','NC','NV','OH','OR','SC','WA','WI')
