...
CASE WHEN ICSC IN ('GT10','GT11') THEN 'Carrier CTF' ELSE 'Carrier FTTC' END PRODUCT, HBE_CIRCUIT,
...
LATA, ICSC, PNUM, DD_COMP, DOCUMENT_NUMBER, ACT, EVC_BDW, LOS, EVC_SPEC, EVC_LEVEL, EVC_CKR, HBE_CIRCUIT,
...
CASE WHEN SUBSTR(UNI_LOC,1,5) = 'CIENA' THEN 'CIENA'
     WHEN SUBSTR(UNI_LOC,1,3) = 'RAD' THEN 'RAD'
...
CASE WHEN LATA IS NOT NULL THEN LATA ELSE LATA_NUMBER END LATA, ICSC,
...
SELECT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, A.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC, EVC_CKR, ICSC, HBE_CIRCUIT,
...
SELECT CKT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, B.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC, EVC_CKR, ICSC, B.HBE_CIRCUIT,
...
WHERE SR.DOCUMENT_NUMBER = ASR.DOCUMENT_NUMBER
  ...
  AND C.LOCATION_ID_2 = NLA.LOCATION_ID
  ...
  --AND SR.DOCUMENT_NUMBER = '3006937';
