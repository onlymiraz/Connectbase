...
SELECT DISTINCT DOCUMENT_NUMBER DOCNO, PON, CKT, DREC, DD, DDD, COMP_DT, DD_COMP DD_TASK_COMP,  
       ...
       CASE WHEN (COMP_DT <= DD OR DD IS NULL) THEN 'Met'
            WHEN (COMP_DT > DD AND WMRCA IN ('CU01','CU02','CU03','CU04','CU05','DS02','CA22','EX01','CU51','CU52','CU53','CU54','DS52','PM53')) THEN 'Met'
            WHEN (COMP_DT > DD AND WMRCA IS NULL AND WHY_MISS IN ('CU01','CU02','CU03','CU04','CU05','DS02','CA22','EX01','CU51','CU52','CU53','CU54','DS52','PM53')) THEN 'Met'
            ELSE 'Miss' END ORIG_DD_STATUS,
       CASE WHEN (COMP_DT <= DDD OR DDD IS NULL) THEN 'Met'
            WHEN (COMP_DT > DDD AND WMRCA IN ('CU01','CU02','CU03','CU04','CU05','DS02','CA22','EX01','CU51','CU52','CU53','CU54','DS52','PM53')) THEN 'Met'
            WHEN (COMP_DT > DDD AND WMRCA IS NULL AND WHY_MISS IN ('CU01','CU02','CU03','CU04','CU05','DS02','CA22','EX01','CU51','CU52','CU53','CU54','DS52','PM53')) THEN 'Met'
...
WHERE SR.DOCUMENT_NUMBER = ASR.DOCUMENT_NUMBER
  ...
  AND TO_CHAR(T.ACTUAL_COMPLETION_DATE,'yyyymm') = '202305'   --CHANGE EACH MONTH - CURRENT REPORTING MONTH  
