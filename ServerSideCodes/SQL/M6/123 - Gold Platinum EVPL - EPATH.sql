...
PRODUCT, HBE_CIRCUIT, EVC_DESIGN_ID, EVC_CKT, UNI_CKT, NNI_CKT, EVC_CKT2, UNI_CKT2, NNI_CKT2,
...
DOCUMENT_NUMBER LAST_ORDER_NO, DD_COMP LAST_COMP_DT,  ACT, EVC_BDW, EVC_LEVEL, HBE_CIRCUIT,
...
-- 7 
SELECT BAN, ACNA, CUSTOMER, ADDRESS, CITY, STATE, LATA,
PNUM, DD_COMP, DOCUMENT_NUMBER, ACT, EVC_BDW, LOS, EVC_SPEC, EVC_LEVEL, HBE_CIRCUIT,
...
-- 6 
SELECT BAN, ACNA,  
CASE WHEN ACNA = 'ATX' AND STATE = 'WI' THEN 'ATT BADGERNET' ELSE CUSTOMER END CUSTOMER,
...
SELECT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, A.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC, HBE_CIRCUIT,
...
SELECT CKT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, B.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC, B.HBE_CIRCUIT,
...
SELECT DISTINCT CKT, ACNA, DOCUMENT_NUMBER, BAN, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       ...
       CASE WHEN LOS = ('EBE') THEN 'Silver'
            ...
            WHEN EVC_SPEC = 'EPATHPS' THEN 'Silver'
            WHEN EVC_SPEC = 'EPATHPR' THEN 'Platinum'
            WHEN EVC_SPEC = 'EPATHPG' THEN 'Gold'
...
SELECT DISTINCT C.EXCHANGE_CARRIER_CIRCUIT_ID CKT, SR.ACNA, SR.DOCUMENT_NUMBER, EVC_IND, TRUNC(ACTUAL_COMPLETION_DATE) DD_COMP,
       ...
       AUD.BAN, C2.STATUS EVC_STATUS, C.CIRCUIT_DESIGN_ID, CUDEVC.HBE_CIRCUIT,
       DECODE (C2.STATUS,
                  '1', 'Pending',
                  '2', 'Assigned',
                  '3', 'In Progress',
...
WHERE SR.DOCUMENT_NUMBER = ASR.DOCUMENT_NUMBER
  ...
  AND ACNA NOT IN ('UCU')
  AND PROMOTION_NBR NOT IN ('EPAVW01999SCM792')
) 
-- 2 
...
WHERE R = 1
AND EVC_STATUS != 'A'
AND (EVC_LEVEL IN ('Gold','Platinum')
 OR PNUM IN (
'EPAV001999300504',
'EPAV001999300533',
'EPAV001999300926',
...
-- 9 
  ...
  MV_GA_INSTANCE GA1,
  MV_GA_INSTANCE GA2
WHERE A3.LOCATION_ID = NLA2.LOCATION_ID
