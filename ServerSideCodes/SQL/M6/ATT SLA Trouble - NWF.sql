...
WHERE A.EXCHANGE_CARRIER_CIRCUIT_ID = E.EXCHANGE_CARRIER_CIRCUIT_ID(+) 
 ...
 AND E.STATUS (+) = '6'
 AND (TO_CHAR(DTE_CLOSEDDATETIME,'yyyymm') = '202010'                                      --NEED TO CHANGE THIS EACH MONTH (CURRENT MONTH)
    OR (DTE_CLOSEDDATETIME IS NULL AND TO_CHAR(FLD_EVENT_END_TIME,'yyyymm') = '202010'))   --NEED TO CHANGE THIS EACH MONTH (CURRENT MONTH) 
