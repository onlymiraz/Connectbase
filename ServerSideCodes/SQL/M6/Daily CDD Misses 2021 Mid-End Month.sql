SELECT DISTINCT DOCNO, PON, ACT, CKT, PROJECT, DREC, DD, DDD, ACCEPT_DT, DD_TASK_COMP, COMP_DT, 
       ...
       NPANXX, EXPEDITE, TASK_LABEL_10, INFINIUM_1 REL_EWO_INFINIUM_1,
...
SELECT DISTINCT DOCUMENT_NUMBER DOCNO, PON, ACT, CKT, DREC, DD, DDD, COMP_DT, DD_COMP DD_TASK_COMP,  
       ...
       DD_WM, RCA_WM, FINAL_WM, TASK_LABEL_10, 
...
SELECT DISTINCT DOCUMENT_NUMBER, ACT, TRUNC(DREC) DREC, DD, DDD, DD_COMP, ACCEPT_DT, 
       ...
       CASE WHEN NC = 'HC' THEN 'DS1'
        ...
        SUPP, CKT, EXPEDITE,  
        CLLI_Z, DATA.NPA||DATA.NXX NPANXX, SUBSTR(NPA.EXCHANGE_AREA_CLLI,5,2) STATE
FROM (
...
WHERE SR.DOCUMENT_NUMBER = ASR.DOCUMENT_NUMBER
  ...
  AND TO_CHAR(T1.ACTUAL_COMPLETION_DATE,'yyyymm') = '202202'    --CHANGE EACH MONTH - CURRENT REPORTING MONTH  
...
GROUP BY DOCNO, PON, ACT, CKT, PROJECT, DREC, DD, DDD, ACCEPT_DT, DD_TASK_COMP, COMP_DT, PROD, ICSC, DATA3.ACNA, STATE, 		
       NPANXX, EXPEDITE, DD_WM, DDDESC, RCA_WM, RCADESC, FINAL_WM, FINALDESC, ORIG_STATUS, FINAL_STATUS, CLLI_Z, TASK_LABEL_10, INFINIUM_1                   
ORDER BY 10,1
;
