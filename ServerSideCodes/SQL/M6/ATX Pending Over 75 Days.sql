SELECT PON, DOCNO, ACNA, ACT_IND, CKT, INIT, CURRENT_RCVD, DD, DDD, ADDRESS, CITY, STATE, ICSC, PRODUCT,
...
SELECT PON, DOCNO, ACNA, ACT_IND, CKT, INIT, D_REC CURRENT_RCVD,DD, DDD, ADDRESS, CITY, 
       ...
       CASE WHEN SUBSTR(PON,4,1) = 'X' THEN 'HOTCUT'
      ...
      CASE WHEN EVC_IND = 'A' THEN 'EVC Pending UNI'
           ...
           WHEN TASK_TYPE IN ('APP','JEOPHOLD','CARREQ') THEN 'ATT Action'
