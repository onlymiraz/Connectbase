select ticket_id, state, clec_id, customer, ckt_id, product, create_date, cleared_dt, closed_dt,                     
       ttr, request_type, repair_code, disp, TROUBLE_DESC                     
from (                    
--                    
select ticket_id, data2.state,                      
       ...
       repair_code, disp, clli_code site_clli, request_type,                    
...
select distinct ticket_id, clec_id, ckt_id, product, create_date, cleared_dt, closed_dt,                     
       ...
       reqstat, location_name, cl.customer, assignmentprofile, request_type, TROUBLE_DESC,                    
...
select distinct ticket_id,                     
       ...
       Total_Duration, TTR, a1.repair_code, b.disp, reqstat, clli_code1, request_type, TROUBLE_DESC,                    
...
select ticket_id, site_clli6, site_state, ckt_id, circuit, a.acna, request_type, create_date,                    
       ...
       assignmentprofile, service_type_code, rate_code, TROUBLE_DESC,                    
...
where a.exchange_carrier_circuit_id = e.EXCHANGE_CARRIER_CIRCUIT_ID(+)                     
 ...
 and e.status (+) = '6'                    
 and (to_char(dte_closeddatetime,'yyyymm') = '202112'    --NEED TO CHANGE THIS EACH MONTH (CURRENT AND PREVIOUS MONTHS)                    
    or (dte_closeddatetime is null and to_char(fld_event_end_time,'yyyymm') >= '202112'))   --NEED TO CHANGE THIS EACH MONTH (CURRENT AND PREVIOUS MONTHS)                     
