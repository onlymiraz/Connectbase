...
AND SITE_STATE IN ('CA','FL') THEN SITE_STATE                                                                                                                                                                                    
       ...
       CASE WHEN SUBSTR(CIRCUIT,3,4) IN ('L1XN','L2XN','L4XN') THEN 'Ethernet'
            ...
            WHEN SERVICE_TYPE_CODE IN ('LU','LV','L1','L2','LO','LZ','SX','CU','L8') THEN 'Ethernet'                                                                                                                                                    
...
WHERE A.FLD_TROUBLEREPORTSTATE = 'closed'                                                                                                                                                                
 ...
 AND SUBSTR(A.EXCHANGE_CARRIER_CIRCUIT_ID,4,2) NOT IN ('EM','DI')                                                                                                                                                                                
 AND (TO_CHAR(DTE_CLOSEDDATETIME,'yyyymm') = '202312'                    
    OR (DTE_CLOSEDDATETIME IS NULL AND TO_CHAR(FLD_EVENT_END_TIME,'yyyymm') = '202312'))                   
