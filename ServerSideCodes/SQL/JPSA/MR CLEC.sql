...
SELECT TICKET_ID, STATE, CLEC_ID, CKT_ID, PRODUCT, CREATE_DATE,                                                                                                                                                                                          
       ...
       TTR,  
       CASE WHEN TTR > 24 THEN 1 ELSE 0 END MISS,
       REPAIR_CODE, DISP, 
...
SELECT DISTINCT TICKET_ID,                                                                                                                                                                                         
       CASE WHEN SITE_STATE IS NOT NULL                                                                                                                                                                                         
             AND SITE_STATE IN ('CA','FL') THEN SITE_STATE                                                                                                                                                                                                            
            WHEN CLLIZ IS NOT NULL                                                                                                                                                                                                             
             AND CLLIZ IN ('CA','FL') THEN CLLIZ                                                                                                                                                                                                     
            WHEN CLLIA IS NOT NULL                                                                                                                                                                                                             
             AND CLLIA IN ('CA','FL') THEN CLLIA                                                                                                                                                                                                    
            WHEN PRILOC IS NOT NULL                                                                                                                                                                                                                 
             AND PRILOC IN ('CA','FL') THEN PRILOC                                                                                                        
            ELSE NULL END STATE,                                                                                                                                                                                        
...
SELECT TICKET_ID, SITE_STATE, CKT_ID, CIRCUIT, A.ACNA, REQUEST_TYPE, CREATE_DATE,
       ...
       ELSE TTR END TTR,
       REPAIR_CODE, TRBL_FOUND_CD, TYPE, SERVICE_TYPE_CODE, REQSTAT,
...
WHERE A.FLD_TROUBLEREPORTSTATE = 'closed'                                                                                                                                                                                        
 ...
 AND E.STATUS (+) = '6'                                                                                                                                                                                      
 AND (TO_CHAR(DTE_CLOSEDDATETIME,'yyyymm') = '202312'  --CHANGE THE DATE EACH MONTH                                                        
   OR (DTE_CLOSEDDATETIME IS NULL AND TO_CHAR(FLD_EVENT_END_TIME,'yyyymm') = '202312'))  --CHANGE THE DATE EACH MONTH                                                                                                                                                                                                   
