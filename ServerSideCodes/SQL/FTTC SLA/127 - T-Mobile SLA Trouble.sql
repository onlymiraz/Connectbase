...
SELECT DISTINCT TICKET_ID, 
       ...
       CASE WHEN CCNA1 IN ('WCG','OPT') THEN CCNA1
            WHEN ACNA3 IN ('WCG','OPT') THEN ACNA3
            WHEN CCNA2 IN ('WCG','OPT') THEN CCNA2
            WHEN ACNA1 IN ('WCG','OPT') THEN ACNA1
            WHEN ACNA2 IN ('WCG','OPT') THEN ACNA2
            WHEN ACNA2 IN ('WCG','OPT') THEN ACNA2
...
WHERE A.EXCHANGE_CARRIER_CIRCUIT_ID = E.EXCHANGE_CARRIER_CIRCUIT_ID(+) 
 ...
 AND E.STATUS (+) = '6'
 -- AND SUBSTR(A.EXCHANGE_CARRIER_CIRCUIT_ID,4,2) <> 'KG'    -- removed on 5/17/2023 
...
-- 4  
WHERE CLEC_ID IN ('WCG','OPT')
  -- AND STATE <> 'CT'  -- removed on 5/17/2023 
