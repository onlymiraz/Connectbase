SELECT DISTINCT TICKET_ID, CREATE_DATE, CLEARED_DT, CLOSED_DT, CKT_ID, 
       ...
       CASE WHEN REQUEST_TYPE = 'Information' THEN 'No'
            WHEN REQUEST_TYPE = 'NOC Ticket' THEN 'No'
...
SELECT DISTINCT TICKET_ID, 
       ...
       CASE WHEN CCNA1 IN ('AWL','IUW') THEN CCNA1
            ...
            WHEN CCNA2 IN ('AWL','IUW') AND CCNA1 IS NULL THEN CCNA2
            WHEN ACNA1 IN ('AWL','IUW') THEN ACNA1
            WHEN ACNA2 IN ('AWL','IUW') AND ACNA1 IS NULL THEN ACNA2
...
WHERE A.EXCHANGE_CARRIER_CIRCUIT_ID = E.EXCHANGE_CARRIER_CIRCUIT_ID(+) 
 ...
 AND E.STATUS (+) = '6'
 AND SUBSTR(A.EXCHANGE_CARRIER_CIRCUIT_ID,4,2) NOT IN ('KG','KJ')
 AND (TO_CHAR(DTE_CLOSEDDATETIME,'yyyymm') = '202401'                                      --NEED TO CHANGE THIS EACH MONTH
    OR (DTE_CLOSEDDATETIME IS NULL AND TO_CHAR(FLD_EVENT_END_TIME,'yyyymm') = '202401'))   --NEED TO CHANGE THIS EACH MONTH 
