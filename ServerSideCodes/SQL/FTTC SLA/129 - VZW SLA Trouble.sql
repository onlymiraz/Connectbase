...
SELECT DISTINCT TICKET_ID, 
       ...
       CASE WHEN CCNA1 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN CCNA1
            WHEN ACNA3 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN ACNA3
            WHEN CCNA2 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN CCNA2
            WHEN ACNA1 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN ACNA1
            WHEN ACNA2 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN ACNA2
            WHEN ACNA2 IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL') THEN ACNA2
...
-- 4  
WHERE CLEC_ID IN ('EBA','NVC','PTM','BAL','DTC','GMT','PPM','PUL')
