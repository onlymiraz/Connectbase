...
where a.fld_troublereportstate = 'closed'
 ...
 and e.status (+) = '6'
 and (to_char(dte_closeddatetime,'yyyymm') in ('202012')    --NEED TO CHANGE THIS EACH MONTH
    or (dte_closeddatetime is null and to_char(fld_event_end_time,'yyyymm') in ('202012')))   --NEED TO CHANGE THIS EACH MONTH
...
and clec_id in ('BEY','CAL','CGP','AEH','ATS','AWX','ENY','FDC','INA','JJJ','HOG','CRV',
                  ...
                  'GSM','GTC','CMA','PLI','XMC','TIM','TIW','TQL','TWD','TWF','TWK','PTH')		 
)
