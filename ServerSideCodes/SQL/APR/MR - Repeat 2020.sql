...
select region, TO_CHAR(CLOSED_DT,'YYYYMM') MONTH, ticket_id, CUSTOMER, CKT_ID, product, STATE, CLEC_ID, create_date, cleared_dt, closed_dt,
       ...
       CASE WHEN DISP IN ('CO','FAC') THEN 'Y' ELSE 'N' END  FFDISP, profile  
from (
...
and clec_id in ('FET','FWN','BUC','BUR','CFA','AHY','ALI','ALN','AQH','ASC','ASI','AVD','AVZ','ENW','ESM','EYA','EYL','EYM','FAB','HSE',
              ...
              'NAO','OER','OVC','SXY','UVA','GIM','BHS','DUK','HFB','OIO','VNH','BPH','COJ','JCV','JNC','OMD','OMQ','MYX',
              'AYD','AYX','DVN','ELG','FBN','GIR','GVA','IFB','IFH','IOC','IOV','MAF','MFR','MFW','MFY','MIX','NRI','OEY','OGT','ORO',
              'PCL','PXM','REN','RKO','SHD','UIC','WOL','WUS','YOB','MEN','MSK','UCN','VIG','IRZ')		 
)
...
select * from aprmr
where month = '202312'
and customer in ('US CELLULAR','SPRINT PCS','TMOBILE','VERIZON WIRELESS')
