SELECT DISTINCT CARRIER, CCNA, 
       STATE, TARIFF_CD, SUBSTP SVC_TYPE, STPDSC SVC_TYPE_DESC, BAN_TYPE, CUSTNAME, SQ5.WTN, SQ5.BTN, MASTERACCOUNTNUMBER STN, 
       GL_MATRIX_CLASS, VOICE_MRC, VOICE_ADJ, VOICE_PRO_RATED, VOICE_TOTAL, SURCHARGE_MRC
 FROM (
SELECT DISTINCT CARRIER, CCNA, 
       STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, MRC, BAN_TYPE, WTN, BTN, MASTERACCOUNTNUMBER, CUSTNAME,
       GL_MATRIX_CLASS,  
...
SELECT CASE WHEN CARRIER_NAME IS NOT NULL THEN CARRIER_NAME ELSE CARRIER END CARRIER, 
       CCNA, STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, MRC, BAN_TYPE, WTN, BTN, MASTERACCOUNTNUMBER, CUSTNAME,
...
WHERE MASTERACCOUNTNUMBER IS NOT NULL
 ...
 LEFT OUTER JOIN EDW_VWMC.EUBS_BILL_REV_ACCT_DETAIL_V AS EUBS ON EUBS.SVC_ACCS_METHD_NO = SQ3.WTN
    WHERE EUBS.BILL_MONTH_DATE ='2023-04-01'
   -- WHERE EUBS.BILL_CYCLE_DT BETWEEN '2023-02-16' AND '2023-03-15'  -- check how far EUBS is loaded
 ...
 GROUP BY CARRIER, CCNA, STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, MRC, BAN_TYPE, 
          WTN, BTN, MASTERACCOUNTNUMBER, GL_MATRIX_CLASS, CUSTNAME    
)SQ5
 LEFT OUTER JOIN 
