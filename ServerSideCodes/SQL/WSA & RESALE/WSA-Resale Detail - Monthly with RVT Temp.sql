SELECT DISTINCT CARRIER, CCNA, STATE, TARIFF_CD, SUBSTP SVC_TYPE, STPDSC SVC_TYPE_DESC, 
       PRODUCT, SQ5.WTN, SQ5.BTN, SQ5.STN, GL_MATRIX_CLASS, 
...
FROM USER_WORK.CM_RVT_TEMP RVT 
 ...
 GROUP BY CARRIER, CCNA, STATE, TARIFF_CD, PRODUCT, SUBSTP, STPDSC,
          WTN, BTN, STN, GL_MATRIX_CLASS, CUSTNAME
 ORDER BY 1,7,3,8;          