SELECT DISTINCT CARRIER, CCNA, 
 ...
 FROM (
SELECT DISTINCT CARRIER, CCNA, 
       STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, BAN_TYPE, WTN, BTN, MASTERACCOUNTNUMBER, CUSTNAME,
...
SELECT CASE WHEN CARRIER_NAME IS NOT NULL THEN CARRIER_NAME ELSE CARRIER END CARRIER, 
       CCNA, STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, BAN_TYPE, WTN, BTN, MASTERACCOUNTNUMBER, CUSTNAME,
...
WHERE MASTERACCOUNTNUMBER IS NOT NULL
 -- AND C2F.TELEPHONENUMBER in ('2177923988')
)SQ1,
 ...
 LEFT OUTER JOIN EDW_VWMC.EUBS_BILL_REV_ACCT_DETAIL_V AS EUBS ON EUBS.SVC_ACCS_METHD_NO = SQ3.WTN
    WHERE EUBS.BILL_MONTH_DATE ='2023-07-01'
 ...
 GROUP BY CARRIER, CCNA, STATE, TARIFF_CD, BAN_TYPE, SUBSTP, STPDSC,
          CUSTNAME, WTN, BTN, MASTERACCOUNTNUMBER, GL_MATRIX_CLASS, CUSTNAME, PRD_SVC_CD, PRD_SVC_CD_DS
 ORDER BY 1,7,3,8;          