...
SELECT DISTINCT A.BILL_SUB_SYS ENV, MSOSO# AS ORDNO, E.XSOPON PON, F.PONACT ACT, 
       ...
       CASE WHEN MSOSTS = 'D' THEN 'CANCELLED'
            WHEN MSOPST > 0 THEN 'COMPLETE' 
       ...
       CASE WHEN MSOPST > 0 THEN NULL 
            WHEN MSOSTS = 'D' THEN NULL
            ELSE CURRENT_DATE - CAST(TO_CHAR(MSOSDT) AS DATE FORMAT 'YYYYMMDD') END AGING,
