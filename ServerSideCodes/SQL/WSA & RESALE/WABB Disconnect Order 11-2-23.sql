SELECT ORD_TYPE, STATUS, WTN, CCNA, 
       CARRIER, POST_DT, SUM(MRC) TOTAL_MRC
   FROM (
SELECT ORD_TYPE, STATUS, WTN, BTN, SE_CODE, SQ.CCNA, 
       SQ.CARRIER_NAME CARRIER, POST_DT,
