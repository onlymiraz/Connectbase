SELECT DISTINCT CARRIER, CCNA, 
       ...
       SQ5.GL_MATRIX_NO, GL_MATRIX_CLASS, BILL_AMT_TYPE_DS, PRD_SVC_CD, PRD_SVC_CD_DS, BILL_CYCLE_DT,
       VOICE_MRC, VOICE_ADJ, VOICE_PRO_RATED, VOICE_TOTAL
 FROM (
SELECT DISTINCT CARRIER, CCNA, 
       STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, MRC, BAN_TYPE, WTN, BTN, MASTERACCOUNTNUMBER, 
       SQ4.GL_MATRIX_NO, GL_MATRIX_CLASS, BILL_AMT_TYPE_DS, PRD_SVC_CD, PRD_SVC_CD_DS, BILL_CYCLE_DT,
...
WHERE MASTERACCOUNTNUMBER IS NOT NULL
    -- AND C2F.TELEPHONENUMBER in ('2092391163')
 ...
 GROUP BY CARRIER, CCNA, STATE, TARIFF_CD, ACCOUNTACTIVATIONDATE, MRC, BAN_TYPE, 
          WTN, BTN, MASTERACCOUNTNUMBER, SQ4.GL_MATRIX_NO, GL_MATRIX_CLASS, BILL_AMT_TYPE_DS,
          PRD_SVC_CD, PRD_SVC_CD_DS, BILL_CYCLE_DT
)SQ5
 LEFT OUTER JOIN 
