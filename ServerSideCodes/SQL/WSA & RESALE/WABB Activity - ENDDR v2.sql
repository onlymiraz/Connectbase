SELECT DISTINCT 'CP1FT' AS ENV, MSOSO# AS ORDNO, MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
...
FULL JOIN CP1FT.SV23 E
 ON A.MSOSO# = E.S23SO#
FULL JOIN CP1##.LSPPON F
 ON E.S23PON# = F.PONPON#
 WHERE SV7ITM IN (
...
select distinct 'CP1CZ' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1MS' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1EA' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1LF' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1CW' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1CA' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1CT' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1AZ' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1LR' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1NW' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1PA' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
...
select distinct 'CP1US' as ENV, MSOSO# AS ORDNO,MSOPH# AS WTN, MSOMB# AS BTN, F.PONCCDE CCNA, MSOLSN||MSOFRN AS CUSTNM,  
       CAST(SUBSTR(MSOSDT,5,2)||'/'||SUBSTR(MSOSDT,7,2)||'/'||SUBSTR(MSOSDT,1,4) AS DATE) SO_CREATE_DT,
       CASE WHEN MSOEDT > 0 THEN CAST(SUBSTR(MSOEDT,5,2)||'/'||SUBSTR(MSOEDT,7,2)||'/'||SUBSTR(MSOEDT,1,4) AS DATE) ELSE NULL END SO_EFF_COMP_DT, 
       CASE WHEN MSOCPD > 0 THEN CAST(SUBSTR(MSOCPD,5,2)||'/'||SUBSTR(MSOCPD,7,2)||'/'||SUBSTR(MSOCPD,1,4) AS DATE) ELSE NULL END SO_ACT_COMP_DT,
       CASE WHEN MSOPST > 0 THEN CAST(SUBSTR(MSOPST,5,2)||'/'||SUBSTR(MSOPST,7,2)||'/'||SUBSTR(MSOPST,1,4) AS DATE) ELSE NULL END POST_DT,
