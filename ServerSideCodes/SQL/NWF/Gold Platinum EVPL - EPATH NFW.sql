-- 8 
SELECT BAN, ACNA, CUSTOMER, ADDRESS, TRIM(CITY) CITY, STATE, LATA, PNUM, 
...
SELECT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, A.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC,
...
SELECT DISTINCT C.EXCHANGE_CARRIER_CIRCUIT_ID CKT, SR.ACNA, SR.DOCUMENT_NUMBER, EVC_IND, TRUNC(ACTUAL_COMPLETION_DATE) DD_COMP,
       ...
       AUD.BAN, C2.STATUS EVC_STATUS, C.CIRCUIT_DESIGN_ID,
       DECODE (C2.STATUS,
                  '1', 'Pending',
                  '2', 'Assigned',
                  '3', 'In Progress',
