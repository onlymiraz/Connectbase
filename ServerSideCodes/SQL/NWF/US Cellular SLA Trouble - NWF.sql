...
SELECT DISTINCT TICKET_ID, 
       ...
       CASE WHEN CCNA1 IN ('UCU') THEN CCNA1
            WHEN ACNA3 IN ('UCU') THEN ACNA3
            WHEN CCNA2 IN ('UCU') THEN CCNA2
            WHEN ACNA1 IN ('UCU') THEN ACNA1
            WHEN ACNA2 IN ('UCU') THEN ACNA2
            WHEN ACNA2 IN ('UCU') THEN ACNA2
