...
PNUM,  DOCUMENT_NUMBER, DD_COMP, ACT, EVC_BDW, LOS, EVC_SPEC, EVC_LEVEL, EVC_CKR,
...
SELECT CKT EVC_CKT, EVC_DESIGN_ID, ACNA, BAN, B.DOCUMENT_NUMBER, EVC_IND, ACT, DD_COMP, UNI_SPEC, PNUM, LOS, EVC_SPEC,
       LATA, ADDRESS, CITY, STATE, EVC_CKR, EVC_BDW, EVC_LEVEL, EVC_STATUS, EVC_STATUS_DESC,
...
WHERE SR.DOCUMENT_NUMBER = ASR.DOCUMENT_NUMBER
  ...
  --AND SR.DOCUMENT_NUMBER = '3460045'
